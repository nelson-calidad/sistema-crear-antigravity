...
<html lang="es">
  ...
  <body>
    ...
    `,!1)},Ka=(e,t)=>{ye();const a=P(e,"MMMM yyyy",{locale:Y}),r=t.filter(m=>{const g=Q(m.date);return g?g.getMonth()===e.getMonth()&&g.getFullYear()===e.getFullYear():!1}),{coverage:n,types:o}=ke(r),c=P(new Date,"dd/MM/yyyy HH:mm",{locale:Y}),h=r.reduce((m,g)=>{const p=Q(g.date);if(!p)return m;const x=P(p,"yyyy-MM-dd");return m[x]=m[x]||[],m[x].push(g),m},{}),f=we({start:R(Ye(e),{weekStartsOn:1}),end:le(Fe(e),{weekStartsOn:1})}),u=f.length?`
      <div class="section">
        <div class="section-header">
    ...
    `,!0)},Za=(e,t)=>{ye();const a=`${P(R(e,{weekStartsOn:1}),"dd/MM/yyyy",{locale:Y})} - ${P(le(e,{weekStartsOn:1}),"dd/MM/yyyy",{locale:Y})}`,{weekDays:r,weekAppointments:n,rooms:o,daySummary:c}=Ga(e,t),h=P(new Date,"dd/MM/yyyy HH:mm",{locale:Y}),{types:f}=ke(n),u=o.reduce((v,q)=>v+q.freeDays,0),m=c.filter(v=>v.freeRooms.length===$.length).length,g=V(e),p=c.find(v=>V(v.day)===g),x=(p==null?void 0:p.freeRooms.length)||0,M=`
    <div class="section">
      <div class="section-header">
      ...
      <div class="week-grid">
        ...
        ${o.map(({room:v,dayCells:q,totalAppointments:k,freeDays:N})=>`
          <div class="week-room">
            <div>
