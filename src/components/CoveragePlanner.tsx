...
import { CalendarDays, CheckCircle2, ChevronLeft, ChevronRight, ClipboardCheck, LoaderCircle, Plus, Printer, RefreshCw, StickyNote, Trash2, X } from 'lucide-react';
...
export const CoveragePlanner = () => {
  ...
  return <>
    ...
    {editor !== undefined && <ShiftForm founders={founders} shift={editor || undefined} onClose={() => setEditor(undefined)} onSave={save} onDelete={remove} saving={saving} />}
    </div>
  </>;
};
