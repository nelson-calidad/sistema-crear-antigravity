  ...
  return (
    <div className="h-full flex flex-col gap-1.5 md:gap-2 min-h-0">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-start">
        <div className="hidden md:block space-y-1 shrink-0 min-w-0">
        ...
        <div className="flex w-full flex-col gap-1.5 lg:flex-1 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex flex-wrap items-center justify-start gap-1.5 w-full lg:w-auto">
      ...
      <div className="hidden md:grid gap-2 [grid-template-columns:repeat(5,minmax(0,1fr))] items-stretch">
        <div className="rounded-xl border border-slate-200 bg-white/85 px-2.5 py-1.5 shadow-sm">
          <p className="text-[8px] font-black uppercase tracking-[0.18em] text-slate-400">Turnos del día</p>
          <p className="mt-0.5 text-base font-black text-slate-900">{appointmentKindSummary.total}</p>
        </div>
        <div className={cn('rounded-xl border px-2.5 py-1.5 shadow-sm', getKindBadgeStyles('session'))}>
          <p className="text-[8px] font-black uppercase tracking-[0.18em] opacity-80">Sesiones</p>
          <p className="mt-0.5 text-base font-black">{appointmentKindSummary.session}</p>
        </div>
        <div className={cn('rounded-xl border px-2.5 py-1.5 shadow-sm', getKindBadgeStyles('interview'))}>
          <p className="text-[8px] font-black uppercase tracking-[0.18em] opacity-80">Entrevistas</p>
          <p className="mt-0.5 text-base font-black">{appointmentKindSummary.interview}</p>
        </div>
        <div className={cn('rounded-xl border px-2.5 py-1.5 shadow-sm', getKindBadgeStyles('block'))}>
          <p className="text-[8px] font-black uppercase tracking-[0.18em] opacity-80">Otros</p>
          <p className="mt-0.5 text-base font-black">{appointmentKindSummary.block}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white/85 px-2.5 py-1.5 shadow-sm">
          <p className="text-[8px] font-black uppercase tracking-[0.18em] text-slate-400">{resourceAvailability.label}</p>
          <p className="mt-0.5 text-base font-black text-slate-900">{resourceAvailability.free}/{resourceAvailability.total}</p>
          <p className="text-[8px] font-semibold uppercase tracking-[0.14em] text-slate-400">{resourceAvailability.busy} ocupados</p>
        </div>
      </div>
