...
export const Agenda = ({ onOpenModal, appointments, focusDate }: AgendaProps) => {
  ...
  return (
    <div className="h-full flex flex-col gap-1.5 md:gap-4 min-h-0">
      <div className="flex flex-col gap-2 xl:flex-row xl:items-end xl:justify-between">
        <div className="space-y-1.5">
          <div className="flex items-start gap-3">
            <div className="p-1.5 md:p-2 rounded-2xl bg-blue-50 text-blue-600 border border-blue-100 shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 text-[9px] font-bold">
              <BadgeInfo className="w-3 h-3" />
              {format(selectedDate, 'EEEE, d MMMM')}
            </span>
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 text-[9px] font-bold">
              {selectedDateAppointments.length} turno{selectedDateAppointments.length === 1 ? '' : 's'} en el día
            </span>
            <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-[9px] font-bold">
        ...
        <div className="grid grid-cols-2 md:flex md:flex-row md:flex-wrap items-stretch md:items-center gap-2 w-full xl:w-auto">
          <div className="flex bg-slate-100 p-0.5 rounded-xl gap-1 col-span-2 md:col-span-1 w-full md:w-auto">
            <button
          ...
          {timeMode === 'daily' && (
            <div className="flex bg-white rounded-xl border border-slate-100 p-1 shadow-sm col-span-2 md:col-span-1 w-full md:w-auto">
              <button
          ...
          {timeMode === 'daily' && (
            <div className="bg-slate-100 p-0.5 rounded-xl flex gap-1 col-span-2 md:col-span-1 w-full md:w-auto">
              <button
          ...
          <button
            onClick={() => onOpenModal()}
            className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl font-bold text-xs hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200 col-span-2 md:col-span-1 w-full md:w-auto"
          >
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center justify-center gap-2 px-4 py-2 bg-white text-slate-700 border border-slate-200 rounded-xl font-bold text-xs hover:bg-slate-50 transition-colors shadow-sm col-span-1 w-full md:w-auto"
          >
                ...
                visibleAppointments.map((app) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn('w-full text-left rounded-2xl p-2.5 border shadow-sm', getTypeStyles(app.type))}
                    >
